...
@Tag(name = "백오피스 관리 계정 상세 조회 API", description = "관리자 계정 상세 조회 하는 API")
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
@Schema(description = "백오피스 관리자 계정 상세 조회 응답")
public class AdminMemberInfoResponse {
    ...
    public AdminMemberInfoResponse(Long memberId,
                                   String email,
                                   String userName,
                                   String phone,
                                   String memberRoles,
    ...
    public AdminMemberInfoResponse(Member member) {
    ...
    public static AdminMemberInfoResponse of(Long memberId,
                                         String email,
                                         String userName,
                                         String phone,
                                         String memberRoles,
                                         String memberState) {
        return new AdminMemberInfoResponse(memberId, email, userName, phone, memberRoles, memberState);
    }

    public static AdminMemberInfoResponse from (Member member) {
        return new AdminMemberInfoResponse(member);
    }
